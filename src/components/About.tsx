...
const About = () => {
  ...
  return <section id="about" className="py-20 bg-gradient-to-b from-white to-cream/30">
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {interests.map((interest, index) => <div key={index} className="flex items-center space-x-3 p-3 rounded-lg bg-white/50 backdrop-blur-sm">
