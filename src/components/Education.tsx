...
const Education = () => {
  ...
  return (
    <section id="education" className="py-20 bg-gradient-to-b from-lavender/20 to-mint/20">
                ...
                <div className="flex flex-wrap gap-2">
                  {edu.achievements.map((achievement, achievementIndex) => (
                    <span
                      ...
                      className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 text-sm rounded-full font-medium"
                    >
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {certifications.map((cert, index) => (
              <div 
                key={index}
                className="glass-card rounded-xl p-6 hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
